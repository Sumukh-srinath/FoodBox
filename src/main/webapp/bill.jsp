...
<h3>Product Details</h3>
  ...
  <%
  ResultSet rs1=st.executeQuery("select * from cart inner join product where cart.product_id=product.id and email='"+email+"' and cart.status='bill'");
  while(rs1.next()){
	  sno=sno+1;
  %>
  <tr>
